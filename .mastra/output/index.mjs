...
import { Agent, Telemetry } from '@mastra/core';
...
`,
  ...
  tools: {
    ...
    // Factory's view of a user's total portfolio
    ...
    getAssetFullDetailsTool,
    // Direct query to an asset
    ...
    getAssetUserAssetInfoTool,
    // User's info for a specific asset
    getAssetSnapshotInfoTool,
    // --- Asset Tools (Writes) ---
    setAssetCompanyValuationTool,
    // Note: This is on ZenovaAsset, typically after factory creation & initialization
    updateAssetPriceTool,
    updateAssetLiquidityParamsTool,
    activateAssetTradingTool,
    deactivateAssetTradingTool,
    buyAssetTokensTool,
    // User action, but AI might guide or provide info
    sellAssetTokensTool,
    // User action, but AI might guide or provide info
